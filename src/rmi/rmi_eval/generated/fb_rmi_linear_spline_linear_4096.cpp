#include "fb_rmi_linear_spline_linear_4096.h"
#include "fb_rmi_linear_spline_linear_4096_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
#include <iostream>
namespace fb_rmi_linear_spline_linear_4096 {
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "fb_rmi_linear_spline_linear_4096_L1_PARAMETERS", std::ios::in | std::ios::binary);
