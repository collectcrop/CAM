#include "osm_cellids_rmi_linear_spline_linear_512.h"
#include "osm_cellids_rmi_linear_spline_linear_512_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
...
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "osm_cellids_rmi_linear_spline_linear_512_L1_PARAMETERS", std::ios::in | std::ios::binary);
