#include "books_rmi_linear_spline_linear_16384.h"
#include "books_rmi_linear_spline_linear_16384_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
...
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "books_rmi_linear_spline_linear_16384_L1_PARAMETERS", std::ios::in | std::ios::binary);
