#include "fb_rmi_linear_spline_linear_64.h"
#include "fb_rmi_linear_spline_linear_64_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
...
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "fb_rmi_linear_spline_linear_64_L1_PARAMETERS", std::ios::in | std::ios::binary);
