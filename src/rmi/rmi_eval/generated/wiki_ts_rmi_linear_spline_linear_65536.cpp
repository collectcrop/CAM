#include "wiki_ts_rmi_linear_spline_linear_65536.h"
#include "wiki_ts_rmi_linear_spline_linear_65536_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
...
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "wiki_ts_rmi_linear_spline_linear_65536_L1_PARAMETERS", std::ios::in | std::ios::binary);
