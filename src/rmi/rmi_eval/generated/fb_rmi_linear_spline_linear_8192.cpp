#include "fb_rmi_linear_spline_linear_8192.h"
#include "fb_rmi_linear_spline_linear_8192_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
...
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "fb_rmi_linear_spline_linear_8192_L1_PARAMETERS", std::ios::in | std::ios::binary);
