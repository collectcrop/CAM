#include "books_rmi_linear_spline_linear_32768.h"
#include "books_rmi_linear_spline_linear_32768_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
...
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "books_rmi_linear_spline_linear_32768_L1_PARAMETERS", std::ios::in | std::ios::binary);
