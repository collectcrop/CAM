...
echo "[config][range-cmp] COLD_START_CORRECTION=$COLD_START_CORRECTION CONSERVATIVE_RANGE_ESTIMATE=$CONSERVATIVE_RANGE_ESTIMATE CAM_WARMUP_POSITION_CACHE=$CAM_WARMUP_POSITION_CACHE"
